// Synthesis-only stub for silu_core_hls_ip.
// Matches port interface of the sim model in silu_core_hls_ip.sv.
...
module silu_core_hls_ip (
  ...
  // ACT_VECTOR_ELEMS/N_TILE = 512/32 = 16 chunks max → 4-bit counter.
